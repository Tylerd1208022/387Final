...
# Global assignments 
set_global_assignment -name TOP_LEVEL_ENTITY "|iq_read"
...
set_global_assignment -section_id iq_read -name EDA_DESIGN_ENTRY_SYNTHESIS_TOOL "SYNPLIFY"
...
set_global_assignment -name SDC_FILE "IQRead.scf"
